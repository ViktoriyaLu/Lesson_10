class flowersSlider {
	...
	//  * @param {String} prefix
	//  */
	constructor(el, config = {}, prefix = 'flowers-slider__') {
		this.#state = {
			prefix: prefix,
			el: el,
	...
	static createInstances() {
		document
			.querySelectorAll('[data-slider="flowers-slider"]')
			.forEach((el) => {
	...
	#move() {
		...
		this.#state.elItems.dispatchEvent(
			new CustomEvent('flowers-slider__transition-start', {
				bubbles: true,
			})
		);
	}
